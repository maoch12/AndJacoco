...
public class ReportGenerator {
     ...
     */
    public ReportGenerator(final File execFile, List<File> classesDir, List<File> sourceDir, File reportDir) {
        this.title = "testReprot";
    ...
    private IBundleCoverage analyzeStructure() throws IOException {
        ...
        final TtpAnalyzer analyzer = new TtpAnalyzer(
    ...
    public static void main(final String[] args) throws IOException {
        File exec = new File("D:\\WorkSpace\\jacoco_plugin\\app\\coverage.ec");

        List<File> sourceDirs = new ArrayList<>();
        sourceDirs.add(new File("D:\\WorkSpace\\jacoco_plugin\\app\\src\\main\\java"));
        sourceDirs.add(new File("D:\\WorkSpace\\jacoco_plugin\\mylibrary\\src\\main\\java"));

        List<File> classDirs = new ArrayList<>();
        classDirs.add(new File("D:\\WorkSpace\\jacoco_plugin\\app\\classes"));

        File reportDir = new File("D:\\WorkSpace\\jacoco_plugin\\app\\report");
        ReportGenerator generator = new ReportGenerator(exec, classDirs, sourceDirs, reportDir);
        generator.create();
    }
